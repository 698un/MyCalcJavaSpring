...
public class VideoFile {
    ...
    private String sourceFolder;//Path to images
    ...
    public void setFolder(String inpFolder){this.videoFolder = inpFolder;}
    public String getFolder(){return this.videoFolder;}
